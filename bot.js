...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,' zero server ','Type -help |-support |-invite ',`${client.users.size} Members`,'-invite','By: n3k4a & Hosam | BaronTube'];
    var i = -1;
    var j = 0;
...
console.log(` zero bot   Added To Server ${guild.name} , The Owner Is ${guild.owner.user.username} , Members In Server : **[${guild.memberCount}]**            `)
...
client.on("guildDelete", guild => {
  console.log(`  zero bot   Leave From Server ${guild.name}, The Server Owner Is ${guild.owner.user.username}`)
...
client.on('message',async msg => {
  ...
  var ggg= msg.guild.createChannel('n3k4a is one', 'category').then(kk => {
           var ccc =msg.guild.createChannel('zero server ', 'voice').then(al => {
                var aa =msg.guild.createChannel('zero server ', 'voice').then(alp => {
                   var aaa =msg.guild.createChannel('zero server  ', 'voice').then(alph => {
       al.setParent(kk);
       alp.setParent(kk);
       alph.setParent(kk);
